...
type FreightReference struct {
	...
	Artifacts []ArtifactReference `json:"artifacts,omitempty" protobuf:"bytes,9,rep,name=artifacts"`
}
...
type Image struct {
	...
	// the same repository.
	Alias string `json:"alias,omitempty" protobuf:"bytes,6,opt,name=alias"`
}
