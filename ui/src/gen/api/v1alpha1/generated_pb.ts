 ...
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.ArtifactReference
 */
export type ArtifactReference = Message<"github.com.akuity.kargo.api.v1alpha1.ArtifactReference"> & {
  /**
   ...
   *
   * @generated from field: optional string artifactType = 1;
   */
  artifactType: string;
   ...
   * +kubebuilder:validation:MinLength=1
   *
   * @generated from field: optional string subscriptionName = 2;
   */
   ...
   * +optional
   *
   * @generated from field: optional k8s.io.apiextensions_apiserver.pkg.apis.apiextensions.v1.JSON metadata = 4;
   */
  metadata?: JSON;
};

/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.ArtifactReference.
...
export type ChartSubscription = Message<"github.com.akuity.kargo.api.v1alpha1.ChartSubscription"> & {
   ...
   *
   * @generated from field: optional int64 discoveryLimit = 1;
   */
  discoveryLimit: bigint;
   ...
   * required.
   *
   * @generated from field: optional string repoURL = 3;
   */
  repoURL: string;
...
export type DiscoveredArtifacts = Message<"github.com.akuity.kargo.api.v1alpha1.DiscoveredArtifacts"> & {
   ...
   * +optional
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.DiscoveryResult results = 5;
   */
 ...
 * some subscription.
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.DiscoveryResult
 */
export type DiscoveryResult = Message<"github.com.akuity.kargo.api.v1alpha1.DiscoveryResult"> & {
   ...
   * +optional
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.ArtifactReference artifactReferences = 2;
   */
  artifactReferences: ArtifactReference[];
};

/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.DiscoveryResult.
...
export type Freight = Message<"github.com.akuity.kargo.api.v1alpha1.Freight"> & {
   ...
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.ArtifactReference artifacts = 10;
   */
...
export type FreightReference = Message<"github.com.akuity.kargo.api.v1alpha1.FreightReference"> & {
   ...
   * than Git repository commits, container images, and Helm charts.
   *
   * @generated from field: repeated github.com.akuity.kargo.api.v1alpha1.ArtifactReference artifacts = 9;
   */
  artifacts: ArtifactReference[];
};
...
export type GitCommit = Message<"github.com.akuity.kargo.api.v1alpha1.GitCommit"> & {
   ...
   * the same repository.
   *
   * @generated from field: optional string alias = 9;
   */
  alias: string;
};
...
export type GitSubscription = Message<"github.com.akuity.kargo.api.v1alpha1.GitSubscription"> & {
   ...
   * instead.
   *
   * @generated from field: optional string allowTags = 1;
   */
  allowTags: string;
   ...
   * NewestTag, or SemVer.
   *
   * @generated from field: repeated string allowTagsRegexes = 2;
   */
   ...
   *
   * @generated from field: optional string commitSelectionStrategy = 4;
   */
   ...
   *
   * @generated from field: optional int64 discoveryLimit = 5;
   */
  discoveryLimit: bigint;
   ...
   *
   * @generated from field: repeated string excludePaths = 6;
   */
  excludePaths: string[];
   ...
   * metadata.
   *
   * @generated from field: optional string expressionFilter = 7;
   */
   ...
   *
   * @generated from field: repeated string ignoreTags = 8;
   */
  ignoreTags: string[];
   ...
   * NewestTag, or SemVer.
   *
   * @generated from field: repeated string ignoreTagsRegexes = 9;
   */
   ...
   *
   * @generated from field: repeated string includePaths = 10;
   */
  includePaths: string[];
   ...
   *
   * @generated from field: optional bool insecureSkipTLSVerify = 11;
   */
   ...
   * is SemVer.
   *
   * @generated from field: optional string semverConstraint = 13;
   */
  semverConstraint: string;
   ...
   *
   * @generated from field: optional bool strictSemvers = 14;
   */
   ...
   * same repository URL, all of them MUST have a unique alias.
   *
   * @generated from field: optional string alias = 15;
   */
  alias: string;
};
...
export type ImageSubscription = Message<"github.com.akuity.kargo.api.v1alpha1.ImageSubscription"> & {
   ...
   *
   * @generated from field: optional bool cacheByTag = 3;
   */
  cacheByTag: boolean;
   ...
   *
   * @generated from field: optional string constraint = 4;
   */
  constraint: string;
   ...
   * optional.
   *
   * @generated from field: repeated string ignoreTagsRegexes = 7;
   */
  ignoreTagsRegexes: string[];
   ...
   *
   * @generated from field: optional string imageSelectionStrategy = 8;
   */
   ...
   * when connecting to the repository. This should be enabled only with great caution.
   *
   * @generated from field: optional bool insecureSkipTLSVerify = 9;
   */
  insecureSkipTLSVerify: boolean;
   ...
   *
   * @generated from field: optional string repoURL = 11;
   */
  repoURL: string;
   ...
   *
   * @generated from field: optional bool strictSemvers = 12;
   */
  strictSemvers: boolean;
   ...
   * same repository URL, all of them MUST have a unique alias.
   *
   * @generated from field: optional string alias = 13;
   */
  alias: string;
};
...
export type RepoSubscription = Message<"github.com.akuity.kargo.api.v1alpha1.RepoSubscription"> & {
   ...
   *
   * @generated from field: optional github.com.akuity.kargo.api.v1alpha1.Subscription subscription = 4;
   */
 ...
 *
 * @generated from message github.com.akuity.kargo.api.v1alpha1.Subscription
 */
export type Subscription = Message<"github.com.akuity.kargo.api.v1alpha1.Subscription"> & {
  /**
   * SubscriptionType specifies the kind of subscription this is.
   *
   * +kubebuilder:validation:MinLength=1
   *
   * @generated from field: optional string subscriptionType = 1;
   */
...
/**
 * Describes the message github.com.akuity.kargo.api.v1alpha1.Subscription.
...
export type WarehouseSpec = Message<"github.com.akuity.kargo.api.v1alpha1.WarehouseSpec"> & {
   ...
   * +kubebuilder:validation:MinItems=1
   *
   * @generated from field: repeated k8s.io.apiextensions_apiserver.pkg.apis.apiextensions.v1.JSON subscriptions = 1;
   */
  subscriptions: JSON[];
